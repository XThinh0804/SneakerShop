				...
				<div class="row">
					<div class="col-12">
						<div class="card">
							<div class="card-body">
								<sf:form class="form"
									action="${resource }/admin/attribute/add-save" method="post"
									modelAttribute="attribute" enctype="multipart/form-data">
									...
									<div class="form-body">
										<div class="row">
											<div class="col-md-6">
												<div class="form-group mb-4">
													...
													<sf:select path="product.id" class="form-control"
														id="product">
														<sf:options items="${products}" itemValue="id"
											...
											<div class="col-md-6">
												<div class="form-group mb-4">
													...
													<sf:input path="size" type="text" class="form-control"
														id="size" name="size" placeholder="attribute size"></sf:input>
												</div>
											</div>
										</div>
										...
										<div class="row">
											<div class="col-md-4">
												<div class="form-group mb-4">
													...
													<sf:input path="quantity" type="text" class="form-control"
														id="quantity" name="quantity" placeholder="attribute quantity"></sf:input>
												</div>
											</div>
										</div>
										...
										<div class="row">
											<div class="col-md-6">
												<div class="form-group mb-4">
													...
													<sf:select path="userCreateAttribute.id" class="form-control"
														id="createBy">
											...
											<div class="col-md-6">
												<div class="form-group mb-4">
													...
													<sf:select path="userUpdateAttribute.id" class="form-control"
														id="updateBy">
														<sf:options items="${users }" itemValue="id"
															itemLabel="username"></sf:options>
													</sf:select>
										...
										<div class="row">
											<div class="col-md-12">
												<div class="form-group mb-4">
													<a href="${resource }/admin/attribute/list"
														class="btn btn-secondary active" role="button"
														aria-pressed="true"
														style="background-color: #516673; color: #fff;"> Back
														to list </a>
													<button type="submit" class="btn btn-primary"
														style="background-color: #85b4d0;">Save add
														product</button>
												</div>
											</div>
										</div>
