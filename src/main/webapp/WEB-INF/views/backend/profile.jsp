						...
						<div class="white-box">
							<div class="user-bg">
								<img width="100%" alt="user"
									src="${resource}/backend/plugins/images/large/img1.jpg" />
								<div class="overlay-box">
									<div class="user-content">
										<a href="javascript:void(0)"><img
											src="${resource}/backend/plugins/images/users/genu.jpg"
											class="thumb-lg img-circle" alt="img" /></a>
										<h4 class="text-white">User Name</h4>
										<h5 class="text-white">${loginedUser.username}</h5>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="white-box">
							<form class="form-horizontal form-material">
								...
								<div class="form-group">
									...
									<div class="col-md-12">
										<input type="text" value="${loginedUser.mobile}"
											class="form-control form-control-line" />
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-12">
										<input type="text" rows="5" value="${loginedUser.description}"
											class="form-control form-control-line" />
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-12">
										<input type="text" value="${loginedUser.address}"
											class="form-control form-control-line" />
									</div>
								</div>
								<div class="form-group">
