...
<body>
				...
				<div class="row">
					<div class="col-12">
						<div class="card">
							...
							<div class="card-body">
								<form action="${resource }/admin/user/list" method="get">
									<div class="table-responsive">

										<div class="row">
											<div class="col-md-2">
												<div class="form-group mb-4">
													<a href="${resource }/admin/user/add" role="button"
											...
											<div class="col-md-4">
												<div class="form-group mb-4">
													<h3>Total users: &nbsp; ${userPagination.totalItems }</h3>
												</div>
											</div>
											...
											<tbody>
												<c:forEach var="user" items="${users}" varStatus="loop">
													<tr>
														...
														<td><a
															href="${resource }/admin/user/edit/${user.id }"
															role="button" class="btn btn-primary">Edit</a><br /> <a
															href="${resource }/admin/user/delete/${user.id }"
	...
	<script type="text/javascript">
		$(document).ready(function() {
			$("#paging").pagination({
				currentPage: ${userPagination.currentPage}, //Trang hien tai
				items: ${userPagination.totalItems}, //Tong so san pham (total products)
				itemsOnPage: ${userPagination.sizeOfPage},
