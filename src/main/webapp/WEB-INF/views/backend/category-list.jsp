...
<body>
				...
				<div class="row">
					<div class="col-12">
						<div class="card">
							...
							<div class="card-body">
								<form action="${resource }/admin/category/list" method="get">
									<div class="table-responsive">

										<div class="row">
											<div class="col-md-2">
												<div class="form-group mb-4">
													<a href="${resource }/admin/category/add" role="button"
											...
											<div class="col-md-4">
												<div class="form-group mb-4">
													<h3>Total categories: &nbsp;
														${categoryPagination.totalItems }</h3>
												</div>
											</div>
											...
											<div class="col-md-6">
												<div class="form-group mb-4">
													<label>Current page</label> <input id="currentPage"
														...
														value="${categoryPagination.currentPage }">
												</div>
											</div>
											...
											<tbody>
												<c:forEach var="category" items="${categories}"
													...
													<tr>
														...
														<td><a
															href="${resource }/admin/category/edit/${category.id }"
															role="button" class="btn btn-primary">Edit</a> <a
															href="${resource }/admin/category/delete/${category.id }"
	...
	<script type="text/javascript">
		$(document).ready(function() {
			$("#paging").pagination({
				currentPage: ${categoryPagination.currentPage}, //Trang hien tai
				items: ${categoryPagination.totalItems}, //Tong so san pham (total products)
				itemsOnPage: ${categoryPagination.sizeOfPage},
