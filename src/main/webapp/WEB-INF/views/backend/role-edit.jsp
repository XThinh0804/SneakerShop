		...
		<div id="page-wrapper">
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-sm-12">
						<div class="white-box">
							<sf:form class="form" action="${resource }/admin/role/edit-save"
								...
								<div class="form-body">
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group mb-4">
												...
												<sf:select path="userCreateRole.id" class="form-control"
													id="userCreateRole">
										...
										<div class="col-md-6">
											<div class="form-group mb-4">
												...
												<sf:select path="userUpdateRole.id" class="form-control"
													id="userUpdateRole">
													<sf:options items="${users }" itemValue="id"
														itemLabel="username"></sf:options>
												</sf:select>
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group mb-4">
												<a href="${resource}/admin/role/list"
													class="btn btn-secondary active" role="button"
													aria-pressed="true"
													style="background-color: #516673; color: #fff;"> Back
													to list </a>
												<button type="submit" class="btn btn-primary"
													style="background-color: #85b4d0;">Save role</button>
											</div>
										</div>
									</div>
