...
<body>
		...
		<div class="navbar-default sidebar" role="navigation">
			<div class="sidebar-nav navbar-collapse slimscrollsidebar">
				<ul class="nav" id="side-menu">
					...
					<li><a href="#" class="waves-effect" aria-expanded="false"><i
				...
				<div class="row">
					<div class="col-12">
						<div class="card">
							...
							<div class="card-body">
								<form action="${resource }/admin/attribute/list" method="get">
									<div class="table-responsive">

										<div class="row">
											<div class="col-md-2">
												<div class="form-group mb-4">
													<a href="${resource }/admin/attribute/add" role="button"
											...
											<div class="col-md-4">
												<div class="form-group mb-4">
													<h3>Total categories: &nbsp;
														${attributePagination.totalItems }</h3>
												</div>
											</div>
											...
											<div class="col-md-6">
												<div class="form-group mb-4">
													<label>Current page</label> <input id="currentPage"
														...
														value="${attributePagination.currentPage }">
												</div>
											</div>
											...
											<tbody>
												<c:forEach var="attribute" items="${attributes}"
													...
													<tr>
														...
														<td>${attribute.userCreateAttribute.username }</td>
														<td>${attribute.userUpdateAttribute.username }</td>
														<td><fmt:formatDate value="${attribute.createDate }"
																pattern="dd-MM-yyyy" /></td>
														<td><fmt:formatDate value="${attribute.updateDate }"
																pattern="dd-MM-yyyy" /></td>

														<td><c:choose>
																<c:when test="${attribute.status }">
																	<span>Active</span>
																</c:when>
																<c:otherwise>
																	<span>Inactive</span>
														...
														<td><a
															href="${resource }/admin/attribute/edit/${attribute.id }"
															role="button" class="btn btn-primary">Edit</a> <a
															href="${resource }/admin/attribute/delete/${attribute.id }"
	...
	<script type="text/javascript">
		$(document).ready(function() {
			$("#paging").pagination({
				currentPage: ${attributePagination.currentPage}, //Trang hien tai
				items: ${attributePagination.totalItems}, //Tong so san pham (total products)
				itemsOnPage: ${attributePagination.sizeOfPage},
