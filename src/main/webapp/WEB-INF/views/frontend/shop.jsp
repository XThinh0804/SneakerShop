					...
					<div class="collapse navbar-collapse justify-content-between"
						...
						<div class="navbar-nav mr-auto py-0">
							<a href="${resource}/index" class="nav-item nav-link">Home</a> <a
								href="${resource}/shop" class="nav-item nav-link active">Shop</a>
							...
							<div class="card product-item border-0 mb-4">
								<div
									...
									<img class="img-fluid w-100"
										src="${classpath}/UploadFiles/${product.avatar}" alt="">
								</div>
								<div
				...
				<div class="row">
					<div class="col-md-4 mb-5">
						...
						<div class="d-flex flex-column justify-content-start">
							<a class="text-dark mb-2" href="${resource}/index"><i
								class="fa fa-angle-right mr-2"></i>Home</a> <a
								class="text-dark mb-2" href="${resource}/shop"><i
