    ...
    <div class="container-fluid bg-secondary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 300px">
            ...
            <div class="d-inline-flex">
                <p class="m-0"><a href="${resource}/index">Home</a></p>
            </div>
        </div>
    </div>
    <!-- Page Header End -->
        ...
        <div class="row px-xl-5">
                ...
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner border">
                        <div class="carousel-item active">
                            <img class="w-100 h-100" src="${classpath}/UploadFiles/${product.avatar}" alt="Image">
                        </div>
                        <c:forEach items="${productImages}" var="productImage">
                        <div class="carousel-item">
                            <img class="w-100 h-100" src="${classpath}/UploadFiles/${productImage.path}" alt="Image">
                        </div>
                        </c:forEach>
                    </div>
            ...
            <div class="col-lg-7 pb-5">
                ...
                <div class="d-flex mb-3">
                    ...
                    <c:forEach var="attribute" items="${attributes}">
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" class="custom-control-input" id="${attribute.id}" name="size">
                ...
                <div class="d-flex align-items-center mb-4 pt-2">
                    ...
                    <button class="btn btn-primary px-3" type="button" onclick="addToCart(${product.id },1, '${product.name }')"><i class="fa fa-shopping-cart mr-1"></i> Add To Cart</button>
                </div>
