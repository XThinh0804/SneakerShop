                ...
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="${resource}/contact" class="nav-item nav-link active">Contact</a>
                        </div>
        ...
        <div class="row px-xl-5">
            <div class="col-lg-7 mb-5">
                <div class="contact-form">
                    ...
                    <sf:form class="form" action="/contact/send" method="post" modelAttribute="contact" >
                        <div class="control-group">
                            <sf:input path="name" type="text" class="form-control" placeholder="Your name..." id="txtName" name="txtName" />
                        </div>
                        <div class="control-group">
                        ...
                        <div class="control-group">
                            <sf:input path="subject" type="text" name="txtSubject" class="form-control" id="txtSubject" placeholder="Subject" />
                            <p class="help-block text-danger"></p>
                        </div>
                        <div class="control-group">
                            <sf:textarea path="message" cols="30" rows="5" class="form-control" id="txtMessage" name="txtMessage"
